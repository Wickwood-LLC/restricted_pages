...
class RestrictedPageLayoutBuilderForm extends EntityForm {
  ...
  public function getBaseFormId() {
    return 'restricted_pages_layout_builder_form';
  }
   ...
   *
   * Save the layout builder element array parents as a property on the top
   * form
