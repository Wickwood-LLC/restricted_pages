...
namespace Drupal\restricted_pages\Plugin\SectionStorage;
...
/**
 * Class RestrictedPageSectionStorage
 *
 * @SectionStorage(
 *   id = "restricted_page",
 *   weight = 20,
 *   context_definitions = {
 *     "display" = @ContextDefinition("entity:restricted_page"),
 *   },
 * )
 *
 * @package Drupal\restricted_pages\Plugin\SectionStorage
 */
class RestrictedPageSectionStorage extends SectionStorageBase implements ContainerFactoryPluginInterface, ThirdPartySettingsInterface {
  ...
  /**
   * Get the restricted_page entity.
   *
   * @return \Drupal\restricted_pages\Entity\RestrictedPage
   */
  protected function getRestrictedPage() {
  ...
  public function getStorageId() {
    return $this->getRestrictedPage()->id();
  }
  ...
  public function buildRoutes(RouteCollection $collection) {
    ...
    $this->buildLayoutRoutes(
      ...
      'admin/structure/restricted-pages/manage/{restricted_page}/layout',
      [
        'parameters' => [
          'restricted_page' => [
            'type' => 'entity:restricted_page',
          ],
        ],
      ],
      $requirements,
  ...
  public function getRedirectUrl() {
    return Url::fromRoute('entity.restricted_page.edit_form', [
      'restricted_page' => $this->getRestrictedPage()->id(),
    ]);
  }
  ...
  public function deriveContextsFromRoute($value, $definition, $name, array $defaults) {
    ...
    $id = !empty($value) ? $value : (!empty($defaults['restricted_page']) ? $defaults['restricted_page'] : NULL);
    if ($id && ($entity = $this->entityTypeManager->getStorage('restricted_page')->load($id))) {
  ...
  public function label() {
    return $this->getRestrictedPage()->label();
  }
  ...
  public function save() {
    return $this->getRestrictedPage()->save();
  }
  ...
  public function setThirdPartySetting($module, $key, $value) {
    $this->getRestrictedPage()->setThirdPartySetting($module, $key, $value);
    return $this;
  }
  ...
  public function getThirdPartySetting($module, $key, $default = NULL) {
    return $this->getRestrictedPage()->getThirdPartySetting($module, $key, $default);
  }
  ...
  public function getThirdPartySettings($module) {
    return $this->getRestrictedPage()->getThirdPartySettings($module);
  }
  ...
  public function unsetThirdPartySetting($module, $key) {
    $this->getRestrictedPage()->unsetThirdPartySetting($module, $key);
    return $this;
  }
  ...
  public function getThirdPartyProviders() {
    return $this->getRestrictedPage()->getThirdPartyProviders();
  }
}
